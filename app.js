            ...
            <div class="hub-levels">
              ${levels
                .map((lvl) => {
                  ...
                  return `<button type="button" class="hub-level-btn hub-level-btn--patterns${isLocked ? ' hub-level-btn--dev' : ''}" data-main="choukai" data-section="choukai" data-level="${lvl}">${lvl}</button>`;
                })
                .join("")}
            </div>
  ...
  async function openDashboard() {
    ...
    try {
      ...
      const validHistory = historyItems
        ...
        .sort((a, b) => {
          // Gunakan timestamp numerik kalau ada, fallback ke tanggal string

              ...
              <div class="menu-panel-card__body">
                ...
                <div class="letter-btn-pair">
                  <button type="button" class="letter-circle-btn" data-hub="letters" data-script="hiragana" title="Hiragana">
                    <svg viewBox="0 0 48 48" aria-hidden="true"><text x="24" y="35" text-anchor="middle" font-size="28" font-family="'Hiragino Kaku Gothic ProN','Yu Gothic',sans-serif" fill="currentColor" stroke="none">あ</text></svg>
                  </button>
                  <button type="button" class="letter-circle-btn" data-hub="letters" data-script="katakana" title="Katakana">
                    <svg viewBox="0 0 48 48" aria-hidden="true"><text x="24" y="35" text-anchor="middle" font-size="28" font-family="'Hiragino Kaku Gothic ProN','Yu Gothic',sans-serif" fill="currentColor" stroke="none">ア</text></svg>
                  </button>
                </div>
              </div>
            </div>

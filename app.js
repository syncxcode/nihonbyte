...
grid.style.display="grid";
  ...
  function updateAccountStatusUI(user) {
    ...
    const status = user.emailVerified ? "<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true" stroke-width="2.5"><polyline points="20 6 9 17 4 12"/></svg> Sudah terverifikasi" : "<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg> Belum terverifikasi";
...
// ==========================================
  ...
  function startExercise(mainType, section, level) {
    ...
    if (mainType === "bunpou") {
      ...
      defaultMinutes = level === "N5" ? 40 : level === "N4" ? 55 : 70; // N3/N2/N1=70
    } else { // Goi
  ...
  function endQuiz() {
    ...
    if (percentage >= 75) {
      statusLabel = "<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg> LULUS";
      colorTheme = "#4ade80"; 
      const passQuotes = [
      ...
      statusLabel = "<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> GAGAL";
      colorTheme = "#fb7185"; 
      const failQuotes = [
  ...
  window.renderReview = function() {
    ...
    currentQuizData.forEach((q, index) => {
      ...
      const statusText = isCorrect ? "<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true"><polyline points="20 6 9 17 4 12"/></svg> BENAR" : "<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> SALAH";
  ...
  function cardImageTemplate(word, expanded = false) {
    ...
    return `
      <div class="card-image ${expandedClass}" id="${cardId}" data-word-id="${wordId}">
        ...
        <button class="card-action-btn play-audio-btn" type="button" data-text="${word.kana || ''}" aria-label="Putar audio"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true" fill="currentColor" stroke="none"><polygon points="5 3 19 12 5 21 5 3"/></svg></button>
  ...
  function renderExpressionPoster() {
    ...
    paginatedExpr.forEach((word) => {
      ...
      card.innerHTML = `
        ...
        <button class="wide-play-btn" type="button" data-text="${word.kana || word.kanji || ''}" aria-label="Putar"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true" fill="currentColor" stroke="none"><polygon points="5 3 19 12 5 21 5 3"/></svg></button>
      `;
  ...
  function renderPatternPoster(level) {
    ...
    paginatedPatterns.forEach((pattern) => {
      ...
      card.innerHTML = `
        ...
        <button class="pattern-audio-btn" type="button" data-text="${pattern.example}" aria-label="Putar audio pola"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true" fill="currentColor" stroke="none"><polygon points="5 3 19 12 5 21 5 3"/></svg></button>
      `;
  ...
  function openModal(word, customRecs = null) {
    ...
    recs.forEach((item) => {
      ...
      recBtn.innerHTML = `
        ...
        <button class="rec-audio-btn" type="button" data-text="${item.kana || ""}" aria-label="Putar audio ${item.kanji || item.kana || ''}"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true" fill="currentColor" stroke="none"><polygon points="5 3 19 12 5 21 5 3"/></svg></button>
      `;
  ...
  document.querySelectorAll(".js-reset-logo").forEach((logoElem) => logoElem.addEventListener("click", () => {
    ...
    if (isPracticeLockedMode || accessMode === "guest") {
      if (isPracticeLockedMode) {
        const messages = [
          "<h3>諦めないで (Jangan Menyerah)! <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true"><path d="M14.5 10c-.83 0-1.5-.67-1.5-1.5v-5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5v5c0 .83-.67 1.5-1.5 1.5z"/><path d="M20.5 10H19V8.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5-.67 1.5-1.5 1.5z"/><path d="M9.5 14.5v-5c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v3H5c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5h4.5z"/><path d="M14.5 10H6l-1 4h10l-1-4z"/></svg></h3><p>Latihan sedang berjalan. Selesaikan dulu sebelum kembali ke beranda.</p>",
          "<h3>ちょっと待って! (Tunggu Sebentar!) <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true"><path d="M18 11V6a2 2 0 0 0-2-2 2 2 0 0 0-2 2"/><path d="M14 10V4a2 2 0 0 0-2-2 2 2 0 0 0-2 2v2"/><path d="M10 10.5V6a2 2 0 0 0-2-2 2 2 0 0 0-2 2v8"/><path d="M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 0 1 2.83-2.82L7 15"/></svg></h3><p>Mode latihan sedang dikunci agar progres kamu tidak hilang.</p>",
  ...
  container.innerHTML = `
    <div style="text-align: center;">
      <h2 style="color: #ff4d6d; margin-bottom: 20px;"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:1em;height:1em;vertical-align:-0.15em" aria-hidden="true"><rect x="2" y="6" width="20" height="12" rx="2"/><line x1="12" y1="2" x2="12" y2="6"/><line x1="12" y1="18" x2="12" y2="22"/><path d="M2 12h4M18 12h4"/></svg> ${titlePrefix} ${type}</h2>

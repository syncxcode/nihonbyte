...
// ==========================================
  ...
  function _startChoukaiTimer() {
    ...
    choukaiTimer = setInterval(() => {
      ...
      const timerEl = document.getElementById("choukai-timer-display");
  ...
  function renderChoukai() {
    ...
    const optBtns = item.options.map((opt, i) => `
      <button class="choukai-opt-btn" data-choukai-index="${i}">
        <span class="choukai-opt-label">${labels[i]}</span>${opt}
      </button>`
    ).join("");
    ...
    grid.innerHTML = `
      <div class="choukai-wrapper-pro">
        ...
        <div class="choukai-session-bar">
          <span class="choukai-session-label">${sessionLabel}${sessionKanji}</span>
          <div class="choukai-timer-wrap">
            ${CHOUKAI_SVG.clock}
            <span id="choukai-timer-display">${formatSessionTime(choukaiTimeLeft)}</span>
          </div>
        </div>
        ...
        <div class="choukai-answer-side">
          <div class="choukai-question-label" id="choukaiQuestionLabel">${item.question}</div>
    ...
    // Event: Akhiri Test — pakai custom confirm modal
    document.getElementById("choukai-finish-btn")?.addEventListener("click", () => {
      openConfirmModal(
        "Akhiri Sesi Choukai?",

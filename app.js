  ...
  function renderPatternPoster(level) {
    ...
    paginatedPatterns.forEach((pattern) => {
      ...
      card.innerHTML = `
        ...
        <button class="pattern-audio-btn" type="button" data-text="${pattern.example}" aria-label="Putar audio pola"><svg viewBox='0 0 24 24' fill='currentColor' stroke='none' style='width:1em;height:1em;vertical-align:-0.15em' aria-hidden='true'><polygon points='5 3 19 12 5 21 5 3'/></svg></button>
      `;

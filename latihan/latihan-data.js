  ...
  "N5": {
    ...
    "bunpou-composition": [
      ...
      },
      {
        ...
        options: ["に", "本", "上が", "上"],
        answer: "本",
        correctOrder: [4, 1, 2, 3], // 上 に 本 が (Note: Fixed target for clarity)
        options: ["に", "が", "本", "上"],
        answer: "本",
      ...
      },
      {
        ...
        options: ["に", "見", "映画を", "へ"],
        answer: "見",
        correctOrder: [3, 2, 1, 4], // 映画を 見 に へ (Note: Target "Movie to see go")
        options: ["に", "見", "映画", "を"],
        answer: "見",
      ...
      },
      {
        ...
        options: ["は", "人", "背が", "高い"],
        answer: "は",
        correctOrder: [4, 2, 1, 3], // 高い 人 は 背が (Target: "Orang yang tinggi itu...")
      ...
      },
      {
        ...
        options: ["人", "どのくらい", "来ました", "が"],
        answer: "来ました",
        correctOrder: [4, 1, 2, 3], // が 人 どのくらい 来ました
      ...
      },
      {
        ...
        options: ["に", "入らないで", "まだ", "は"],
        answer: "入らないで",
        correctOrder: [3, 4, 1, 2], // まだ は に 入らないで (Target: "Masih jangan masuk ke...")
      ...
      },
      {
        ...
        options: ["が", "車", "青い", "一台"],
        answer: "青い",
        correctOrder: [2, 1, 3, 4], // 車 が 青い 一台 (Target: "Ada satu mobil biru")
        options: ["青い", "が", "車", "一台"],
        answer: "が",
      ...
      },
      {
        ...
        options: ["を", "砂糖を", "入れないで", "ひとつ"],
        answer: "砂糖を",
        correctOrder: [1, 4, 2, 3], // コーヒー ひとつ 砂糖を 入れないで (Note: Order adjustment)
        options: ["砂糖", "を", "入れないで", "ひとつ"],
        answer: "入れないで",
        correctOrder: [1, 2, 4, 3], // 砂糖 を ひとつ 入れないで (No sugar, one coffee)
      ...
      },
      {
        ...
        options: ["天気", "いい", "とても", "が"],
        answer: "いい",
        correctOrder: [3, 2, 1, 4], // とても いい 天気 が
      ...
      },
      {
        ...
        options: ["暑く", "あまり", "天気は", "よく"],
        answer: "暑く",
        correctOrder: [3, 2, 4, 1], // 天気は あまり よく 暑く
      ...
      },
      {
        ...
        options: ["少し", "閉めて", "を", "から"],
        answer: "を",
        correctOrder: [4, 1, 3, 2], // から 少し を 閉めて (Note: Fix target)
      ...
      },
      {
        ...
        options: ["で", "どのくらい", "歩いて", "分"],
        answer: "歩いて",
        correctOrder: [3, 1, 2, 4], // 歩いて で どのくらい 分 (Target: "Berapa menit jalan kaki?")
      ...
      },
      {
        ...
        options: ["は", "どこ", "国", "どちら"],
        answer: "どこ",
        correctOrder: [3, 1, 2, 4], // 国 は どこ どちら (Target: "Negaranya dimana?")
        options: ["は", "どちら", "国", "ですか"],
        answer: "国",
      ...
      },
      {
        ...
        options: ["が", "天気", "雨", "悪い"],
        answer: "悪い",
        correctOrder: [2, 1, 3, 4], // 天気 が 雨 悪い (Target: "Kemarin cuaca buruk karena hujan")
      ...
      },
      {
        ...
        options: ["に", "入る", "前に", "ノックして"],
        answer: "前に",
        correctOrder: [2, 3, 1, 4], // 入る 前に に ノックして (Note: Fix order)
      ...
      },
      {
        ...
        options: ["から", "仕事が", "遅くまで", "あったので"],
        answer: "あったので",
        correctOrder: [2, 4, 3, 1], // 仕事が あったので 遅くまで から (Target: ...sampai larut karena ada kerjaan)
      ...
      },
      {
        ...
        options: ["あまり", "お酒", "強いですから", "は"],
        answer: "お酒",
        correctOrder: [3, 2, 4, 1], // 強いですから お酒 は あまり (Note: logic "Karena kuat...")
      ...
      },
      {
        ...
        options: ["毎日", "仕事で", "を", "家でも"],
        answer: "を",
        correctOrder: [4, 1, 3, 2], // 家でも 毎日 を 仕事で (Note: Order adjustment)
        options: ["を", "仕事に", "毎日", "家で"],
        answer: "毎日",
      ...
      },
      {
        ...
        options: ["は", "何も", "デパートで", "お菓子"],
        answer: "何も",
        correctOrder: [3, 2, 4, 1], // デパートで 何も お菓子 は (Note: Adjustment)
      ...
      },
      {
        ...
        options: ["に", "家まで", "毎日", "20分"],
        answer: "20分",
        correctOrder: [3, 2, 1, 4], // 毎日 家まで に 20分 (Note: adjustment)
      ...
      },
      {
        ...
        options: ["は", "花", "色が", "とても"],
        answer: "色が",
        correctOrder: [2, 1, 4, 3], // 花 は とても 色が (Target: "Bunga ini warnanya...")
      ...
      },
      {
        ...
        options: ["に", "一緒に", "ジュースを", "飲み"],
        answer: "ジュースを",
        correctOrder: [2, 3, 1, 4], // 一緒に ジュースを に 飲み (Note: adjustment)
      ...
      },
      {
        ...
        options: ["で", "走って", "急いで", "ここまで"],
        answer: "走って",
        correctOrder: [3, 4, 2, 1], // 急いで ここまで 走って で (Note: adjustment)
      ...
      },
      {
        ...
        options: ["だんだん", "暗く", "夕方に", "なって"],
        answer: "暗く",
        correctOrder: [3, 1, 2, 4], // 夕方に だんだん 暗く なって (Note: adjustment)
      ...
      },
      {
        ...
        options: ["を", "熱い", "もう一杯", "どうぞ"],
        answer: "もう一杯",
        correctOrder: [2, 1, 3, 4], // 熱い お茶 を もう一杯 どうぞ (Note: adjustment)
      ...
      },
      {
        ...
        options: ["で", "いつも", "自転車", "20分"],
        answer: "自転車",
        correctOrder: [2, 3, 1, 4], // いつも 自転車 で 20分 (Note: order)
      ...
      },
      {
        ...
        options: ["は", "月曜日", "休み", "から"],
        answer: "休み",
        correctOrder: [2, 1, 4, 3], // 月曜日 は から 休み (Target: "Besok libur mulai senin")
    ...
    "bunpou-text": [
      ...
      },
      {
        ...
        answer: "食べます",
        translation: "Konteks sarapan (朝ごはん): Makan sarapan."
      },
      {
        passage: "田中さんは 毎朝 6時に おきます。 [ 1 ] 、顔を あらいます。それから 朝ごはんを [ 2 ] 。家を 7時半 [ 3 ] 出ます。会社まで 電車 [ 4 ] 行きます。仕事は 9時から 5時 [ 5 ] です。",
        questionId: "3",
      ...
      },
      {
        ...
        answer: "にぎやか",
        translation: "Konteks banyak orang di supermarket: Ramai."
      },
      {
        passage: "昨日、私は スーパーへ 行きました。りんご [ 11 ] 100円でした。私は 5つ [ 12 ] 。スーパーには 人が たくさん [ 13 ] 。とても [ 14 ] でした。パンと 牛乳 [ 15 ] 買いました。",
        questionId: "15",
      ...
      },
      {
        ...
        answer: "食べます",
        translation: "Konteks makan nasi (ごはん)."
      },
      {
        passage: "私の 家族は 4人です。父と 母と 妹 [ 16 ] 私です。父は 銀行で 働いて います。 [ 17 ] 母は 先生です。母は 毎日 忙しいですが、いつも [ 18 ] です。夜は 家族で いっしょに ごはんを [ 19 ] 。私の 家族は とても [ 20 ] です。",
        questionId: "20",
      ...
      },
      {
        ...
        answer: "食べない",
        translation: "Larangan (~naide kudasai): Tolong jangan makan."
      },
      {
        passage: "ここは 図書館です。図書館では [ 31 ] して ください。食べ物を [ 32 ] で ください。本を 借りる [ 33 ] が できます。借りた 本は 2週間以内に [ 34 ] ください。大きな 声で [ 35 ] で ください。",
        questionId: "33",
      ...
      },
      {
        ...
        answer: "騒がない",
        translation: "Larangan di perpustakaan: Tolong jangan berisik."
      },
      ...
      },
      {
        ...
        answer: "来ます",
        translation: "Konteks kehadiran: Semuanya datang."
      },
      {
        passage: "明日、学校で パーティーが あります。 [ 36 ] が 来ますか。先生も 学生も みんな [ 37 ] 。私は お菓子を [ 38 ] 行きます。いっしょに 歌を [ 39 ] 。きっと [ 40 ] でしょう。",
        questionId: "38",
      ...
      },
      {
        ...
        answer: "注文しました",
        translation: "Konteks di restoran: Memesan pizza."
      },
      {
        passage: "昨日、私は レストランへ 行きました。メニューは とても [ 41 ] わかりやすかったです。私は ピザを [ 42 ] 。ピザは [ 43 ] 美味しかったです。友達は コーヒーを [ 44 ] 。私たちは 2時間 [ 45 ] 話しました。",
        questionId: "43",
      ...
      },
      {
        ...
        answer: "飲みました",
        translation: "Konteks kopi: Meminum kopi."
      },
      {
        passage: "昨日、私は レストランへ 行きました。メニューは とても [ 41 ] わかりやすかったです。私は ピザを [ 42 ] 。ピザは [ 43 ] 美味しかったです。友達は コーヒーを [ 44 ] 。私たちは 2時間 [ 45 ] 話しました。",
        questionId: "45",
      ...
      },
      {
        ...
        answer: "します",
        translation: "Konteks mengadakan pesta (party wo shimasu)."
      },
      {
        passage: "田中さんへ。お元気ですか。私は とても [ 46 ] です。来週、私の 家で パーティーを [ 47 ] 。田中さんも [ 48 ] か。時間を [ 49 ] ください。 [ 50 ] います。マリアより。",
        questionId: "48",
      ...
      },
      {
        ...
        answer: "食べました",
        translation: "Konteks makanan (ikan): Makan ikan lezat."
      },
      {
        passage: "夏休み、私は 家族と 海へ 行きました。海は とても [ 51 ] 綺麗でした。私たちは 海で [ 52 ] 。それから、美味しい 魚を [ 53 ] 。海は 少し 遠い [ 54 ] 、車で 3時間 かかりました。来年も また [ 55 ] 行きたいです。",
        questionId: "54",
      ...
      },
      {
        ...
        answer: "買います",
        translation: "Konteks belanja: Membeli sayur dan daging."
      },
      {
        passage: "私は 料理を 作る [ 56 ] が 好きです。毎週末、スーパーで 野菜や 肉を [ 57 ] 。台所で ナイフを使って 野菜を [ 58 ] 。私の 料理は [ 59 ] 美味しいです。いつか レストランを [ 60 ] つもりです。",
        questionId: "58",
        ...
        answer: "切ります",
        translation: "Konteks menggunakan pisau (ナイフ): Memotong sayuran."
      },
      {
        passage: "私は 料理を 作る [ 56 ] が 好きです。毎週末、スーパーで 野菜や 肉を [ 57 ] 。台所で ナイフを使って 野菜を [ 58 ] 。私の 料理は [ 59 ] 美味しいです。いつか レストランを [ 60 ] つもりです。",
        questionId: "59",
        options: ["とても", "あまり", "ぜんぜん", "すこし"],
        answer: "とても",
        translation: "Keterangan derajat: Sangat lezat."
      },
      {
        passage: "私は 料理を 作る [ 56 ] が 好きです。毎週末、スーパーで 野菜や 肉を [ 57 ] 。台所で ナイフを使って 野菜を [ 58 ] 。私の 料理は [ 59 ] 美味しいです。いつか レストランを [ 60 ] つもりです。",
        questionId: "60",
      ...
      },
      {
        ...
        answer: "たくさん",
        translation: "Keterangan jumlah: Ada banyak buku."
      },
      {
        passage: "私の 部屋は あまり [ 66 ] ありませんが、とても 綺麗です。机の 上に 本が [ 67 ] あります。机の [ 68 ] に 椅子が あります。私は 毎日 ここで 勉強を [ 69 ] 。窓が 大きい [ 70 ] 、とても 明るい 部屋です。",
        questionId: "68",
      ...
      },
      {
        ...
        options: ["します", "あります", "います", "なります"],
        answer: "します",
        translation: "Konteks melakukan sesuatu: Melakukan belajar."
      },
      {
        passage: "私の 部屋は あまり [ 66 ] ありませんが、とても 綺麗です。机の 上に 本が [ 67 ] あります。机の [ 68 ] に 椅子が あります。私は 毎日 ここで 勉強を [ 69 ] 。窓が 大きい [ 70 ] 、とても 明るい 部屋です。",
        questionId: "70",
      ...
      },
      {
        ...
        answer: "聞いて",
        translation: "Konteks CD: Mendengarkan."
      },
      {
        passage: "私は 3ヶ月前から 日本語を 勉強 [ 76 ] います。平仮名と 片仮名は [ 77 ] 覚えましたが、漢字は まだ 難しいです。先生は とても [ 78 ] 教えてくれます。毎日、CDを [ 79 ] 練習します。早く 上手に [ 80 ] です。",
        questionId: "80",
      ...
      // TEKS 19: 忙しい 週末 (Akhir Pekan yang Sibuk)
      {
        ...
        options: ["掃除", "洗濯", "料理", "散歩"],
        answer: "掃除",
        translation: "Konteks membersihkan kamar: Souji."
      },
      {
        passage: "今週の 土曜日は とても 忙しかったです。朝、部屋を [ 91 ] しました。それから、服を [ 92 ] しました。昼ご飯を 食べてから、デパートへ 買い物に [ 93 ] 。夜は 友達と レストランで 会いました。たくさん 話して [ 94 ] です。明日は ゆっくり [ 95 ] です。",
        questionId: "92",
        options: ["洗濯", "掃除", "料理", "仕事"],
        answer: "洗濯",
        translation: "Konteks mencuci pakaian: Sentaku."
      },
      {
        passage: "今週の 土曜日は とても 忙しかったです。朝、部屋を [ 91 ] しました。それから、服を [ 92 ] しました。昼ご飯を 食べてから、デパートへ 買い物に [ 93 ] 。夜は 友達と レストランで 会いました。たくさん 話して [ 94 ] です。明日は ゆっくり [ 95 ] です。",
        questionId: "93",
      ...
      },
      {
        ...
        answer: "飲んで",
        translation: "Konteks obat: Minum obat."
      },
      {
        passage: "昨日から 少し 熱が あります。喉も [ 96 ] です。今日は 学校を [ 97 ] 病院へ 行きました。先生に「風邪ですね」と 言われました。薬を [ 98 ] 早く 寝て ください。今日は お風呂に [ 99 ] で ください。明日は [ 100 ] に なるでしょう。",
        questionId: "99",
        ...
        answer: "入らない",
        translation: "Larangan: Jangan mandi berendam (ofuro)."
      },
      {
        passage: "昨日から 少し 熱が あります。喉も [ 96 ] です。今日は 学校を [ 97 ] 病院へ 行きました。先生に「風邪ですね」と 言われました。薬を [ 98 ] 早く 寝て ください。今日は お風呂に [ 99 ] で ください。明日は [ 100 ] に なるでしょう。",
        questionId: "100",
  ...
  "N4": {
    ...
    "bunpou-composition": [
      ...
      },
      {
        ...
        options: ["練習", "すれば", "日本語が", "上手に"],
        answer: "上手に",
        correctOrder: [3, 1, 4, 2], // 日本語が 練習 すれば 上手に (Note: adjustment for grammar)
      ...
      },
      {
        ...
        options: ["明日", "らしい", "来る", "忙しい"],
        answer: "来る",
        correctOrder: [1, 4, 2, 3], // 明日 忙しい らしい 来る (Correction for logic)
      ...
      },
      {
        ...
        options: ["開けて", "涼しい", "あります", "風が"],
        answer: "あります",
        correctOrder: [4, 2, 1, 3], // 風が 涼しい 開けて あります (Logic fix)
      ...
      },
      {
        ...
        options: ["砂糖が", "入って", "たくさん", "入れて"],
        answer: "入って",
        correctOrder: [1, 3, 4, 2], // 砂糖が たくさん 入れて 入って (Logic fix)
      ...
      {
        question: "田中さんは ______ ______ __★__ ______ います。",
        options: ["ながら", "新聞を", "テレビを", "読み"],
        answer: "読み",
        correctOrder: [3, 2, 4, 1], // テレビを 新聞を 読み ながら (Logic fix)
      ...
      },
      {
        ...
        options: ["ことに", "合格する", "合格した", "なり"],
        answer: "なり",
        correctOrder: [2, 1, 4, 3], // 合格する ことに なり (Wait, koto ni naru after result)
      ...
      },
      {
        ...
        options: ["ことに", "飲まない", "健康のために", "決めて"],
        answer: "ことに",
        correctOrder: [3, 2, 1, 4], // 健康のために 飲まない ことに (Note: Fix order)
      ...
      },
      {
        ...
        options: ["綺麗に", "海が", "景色は", "とても"],
        answer: "とても",
        correctOrder: [3, 4, 1, 2], // 景色は とても 綺麗に 海が (Note: Fix order)
      ...
      },
      {
        ...
        options: ["甘くて", "砂糖が", "入っている", "ような"],
        answer: "ような",
        correctOrder: [2, 3, 1, 4], // 砂糖が 入っている 甘くて ような (Logic fix)
      ...
      },
      {
        ...
        options: ["ことに", "行く", "予定に", "なり"],
        answer: "予定に",
        correctOrder: [2, 1, 4, 3], // 行く ことに なり 予定に (Logic fix)
      ...
      },
      {
        ...
        options: ["涼しい", "開けて", "風が", "あるので"],
        answer: "開けて",
        correctOrder: [3, 1, 4, 2], // 風が 涼しい あるので 開けて (Logic fix)
      ...
      },
      {
        ...
        options: ["降って", "傘を", "いても", "持って"],
        answer: "傘を",
        correctOrder: [1, 3, 4, 2], // 降って いても 持って 傘を (Logic: "Meskipun hujan...")
      ...
      },
      {
        ...
        options: ["事故が", "あった", "込んで", "いるのは"],
        answer: "あった",
        correctOrder: [4, 3, 1, 2], // 込んでいるのは 事故が あった
      ...
      },
      {
        ...
        options: ["を", "カメラ", "新しい", "探して"],
        answer: "新しい",
        correctOrder: [3, 4, 1, 2], // 新しい 辞書を 探して (Logic fix)
      ...
      },
      {
        ...
        options: ["遅くまで", "起きて", "夜", "いない"],
        answer: "起きて",
        correctOrder: [3, 1, 2, 4], // 夜 遅くまで 起きて いない (Logic fix)
      ...
      },
      {
        ...
        options: ["通訳に", "将来", "使って", "なりたいと"],
        answer: "使って",
        correctOrder: [2, 3, 1, 4], // 将来 使って 通訳に なりたいと (Logic fix)
      ...
      {
        question: "田中さんは ______ ______ __★__ ______ です。",
        options: ["はず", "結婚して", "いる", "まだ"],
        answer: "いる",
        correctOrder: [4, 2, 3, 1], // まだ 結婚して いる はず (Note: context fix)
      ...
      },
      {
        ...
        options: ["ように", "漢字を", "忘れない", "練習する"],
        answer: "ように",
        correctOrder: [2, 3, 4, 1], // 漢字を 忘れない 練習する ように (Logic fix)
      ...
      },
      {
        ...
        options: ["傘を", "止んだら", "持って", "すぐに"],
        answer: "すぐに",
        correctOrder: [2, 4, 1, 3], // 止んだら すぐに 傘を 持って (Logic fix)
      ...
      },
      {
        ...
        options: ["渇いて", "何か", "飲み物", "いたい"],
        answer: "渇いて",
        correctOrder: [2, 3, 1, 4], // 何か 飲み物 渇いて いたい (Logic fix)
    ...
    "bunpou-text": [
      ...
      },
      {
        ...
        answer: "できるだけ",
        translation: "Keterangan derajat: Sebisa mungkin (melanjutkan)."
      },
      {
        passage: "健康の ために、毎日 30分 [ 11 ] 走る ことに して います。あまり 忙しい ときは 走りませんが、[ 12 ] 続けようと 思って います。また、夜は 甘い ものを [ 13 ] ように 注意して います。体が [ 14 ] なると、仕事も [ 15 ] やすく なります。",
        questionId: "13",
      ...
      // TEKS 4: インターネット (Internet)
      {
        ...
        questionId: "16",
        options: ["調べられる", "調べさせる", "調べられる", "調べられる"],
        answer: "調べられる",
      ...
      },
      {
        ...
        answer: "すぐに",
        translation: "Keterangan waktu: (Bisa mencari tahu) dengan segera."
      },
      {
        passage: "今は インターネットで 何でも [ 16 ] 時代です。わからない ことが あれば、[ 17 ] 調べる ことが できます。とても 便利 [ 18 ] 、悪い 点も あります。嘘の ニュースも [ 19 ] ので、どれが 正しいか [ 20 ] なければなりません。",
        questionId: "18",
      ...
      },
      {
        passage: "お元気ですか。私は 今、新しい 会社で [ 21 ] います。仕事は 難しいですが、先輩が 親切に [ 22 ] くれるので 頑張って います。田中さんも 忙しい [ 23 ] 思いますが、無理を [ 24 ] ください。また いつか [ 25 ] ましょう。",
        questionId: "24",
        options: ["しないで", "しないでください", "しないで", "しなくて"],
        answer: "しないで",
      ...
      },
      {
        ...
        answer: "不便",
        translation: "Konteks jarak jauh dari stasiun: Tidak praktis (fuben)."
      },
      {
        passage: "来週、新しい 家に [ 26 ] ことに なりました。今の 家は 駅から 遠くて [ 27 ] でしたが、新しい 家は 駅から 歩いて 5分です。荷物が たくさん あるので、友達に [ 28 ] もらいます。引っ越しが [ 29 ] 、遊びに [ 30 ] ください。",
        questionId: "28",
      ...
      },
      {
        ...
        answer: "よく",
        translation: "Keterangan derajat: (Mencari tahu) dengan baik/teliti."
      },
      {
        passage: "昨日、初めて ケーキを [ 31 ] みました。作りかたを [ 32 ] 調べましたが、砂糖を 入れ [ 33 ] しまいました。とても 甘くなって、[ 34 ] 食べられませんでした。次は 間違えない [ 35 ] 気を つけます。",
        questionId: "33",
      ...
      },
      {
        ...
        answer: "お土産",
        translation: "Konteks oleh-oleh saat berkunjung."
      },
      {
        passage: "日本の 家に 入る とき、靴を [ 36 ] なければなりません。これは 部屋を [ 37 ] ためです。また、友達の 家へ 行く ときは [ 38 ] を 持って 行く 習慣が あります。渡す ときは「つまらない ものですが」と [ 39 ] ことも [ 40 ] 。",
        questionId: "39",
      ...
      },
      {
        ...
        answer: "伝え",
        translation: "Konteks menyampaikan keinginan (Tsutaemashita)."
      },
      {
        passage: "昨日、新しい 会社の 面接に [ 51 ] 。社長は とても 丁寧に [ 52 ] くださいました。私は 将来、この 会社で 日本語を [ 53 ] 通訳に なりたいと [ 54 ] ました。結果は 来週の 月曜日までに [ 55 ] そうです。",
        questionId: "55",
...
// ==========================================
// DATABASE LATIHAN DOKKAI (MEMBACA) N5 & N4
// ==========================================
...
window.latihanDokkaiReal = {
  "N5": [
    ...
    // Tambahkan TEKS INDUK selanjutnya di sini pakai koma...
  ],
  ...
  "N4": [
    ...
    // Tambahkan TEKS INDUK N4 selanjutnya di sini...
  ]
};
